...
src = struct('freq_mhz', freq_mhz, 'volt_mVpp', volt_mV, 'volt_out_mVpp', volt_mV, ...
    'prf_hz', prf_hz, 'n_cycle', n_cycle, 'npts', npts, 'fs_target', fs_target, ...
    'realFs', realFs, 'n_expect', 1, 'dbg_freq', freq_mhz, 'dbg_volt', volt_mV, ...
    'waveform_format', info.waveform_format, 'sweep', 'SINGle', ...

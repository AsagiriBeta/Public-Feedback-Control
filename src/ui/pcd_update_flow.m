function pcd_update_flow(fig)
%PCD_UPDATE_FLOW 「检查更新」的完整交互流程（GUIDE 界面与网页界面共用）。
...
% 好让窗口的 CloseRequestFcn（pcd_ui_app 里的 pcd_ui_close）生效、参数照常存盘；
